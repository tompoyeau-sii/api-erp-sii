...
module.exports = {
    ...
    create: async function (req, res) {
        ...
        try {
            const associateFound = await models.Associate.findOne({
                where: {
                    id: associate_id
                }
            });
    ...
    update: async function (req, res) {
        ...
        try {
            ...
            let mission = await models.Mission.findOne({
                where: {
                    id: mission_id
                },
            });
            let LastTJM = await models.TJM.findOne({
                where: {
            ...
            const associate = await models.Associate.findByPk(mission.associate_id);
