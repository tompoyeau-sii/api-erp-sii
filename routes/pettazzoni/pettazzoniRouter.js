...
const accountController = require("../../controller/pettazzoni/accountController");
const associateController = require("../../controller/pettazzoni/associateController");
const customerController = require("../../controller/pettazzoni/customerController");
const genderController = require("../../controller/pettazzoni/genderController");
const graduationController = require("../../controller/pettazzoni/graduationController");
const jobController = require("../../controller/pettazzoni/jobController");
const projectController = require("../../controller/pettazzoni/projectController");
const missionController = require("../../controller/pettazzoni/missionController");
const pdcController = require("../../controller/pettazzoni/pdcController");
const statController = require("../../controller/pettazzoni/statController");
const environmentController = require("../../controller/pettazzoni/environmentController");
const pruController = require("../../controller/pettazzoni/pruController");
const workeddaysController = require("../../controller/pettazzoni/workeddaysController");
