...
const accountController = require("../../controller/maillard/accountController");
const associateController = require("../../controller/maillard/associateController");
const customerController = require("../../controller/maillard/customerController");
const genderController = require("../../controller/maillard/genderController");
const graduationController = require("../../controller/maillard/graduationController");
const jobController = require("../../controller/maillard/jobController");
const projectController = require("../../controller/maillard/projectController");
const missionController = require("../../controller/maillard/missionController");
const pdcController = require("../../controller/maillard/pdcController");
const statController = require("../../controller/maillard/statController");
const environmentController = require("../../controller/maillard/environmentController");
const pruController = require("../../controller/maillard/pruController");
const workeddaysController = require("../../controller/maillard/workeddaysController");
