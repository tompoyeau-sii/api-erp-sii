 ...
 */
  ...
  */
  ...
  /**
    ...
    * tags:
    *   name: Associate
    *   description: Rotues pour la gestion des associés
    */
 ...
 */
  ...
  /**
     ...
     * tags:
     *   name: Customer
     *   description: Route pour la gestion des clients
     */
  ...
  * tags:
  *   name: Gender
  *   description: Route pour la gestion des Gender
  */
 ...
 */
   ...
   * tags:
   *   name: Job
   *   description: Route pour la gestion des Job
   */
 ...
 * tags:
 *   name: Graduation
 *   description: Route pour la gestion des Graduation
 */
  /**
 * @swagger
 * /api/graduation:
 ...
 */
  ...
  /**
    ...
    * tags:
    *   name: Mission
    *   description: Route pour la gestion des Mission
    */
  ...
  */
  ...
  /**
    ...
    * tags:
    *   name: PDC
    *   description: Route pour la gestion des Pdc
    */
  /**
   * @swagger
   * /api/pdc:
...
* tags:
*   name: Project
*   description: Route pour la gestion des Project
*/
  /**
   * @swagger
   * /api/project:
 ...
 */
  ...
  /**
    ...
    * tags:
    *   name: Statistique
    *   description: Route pour la gestion des Statistique
    */
