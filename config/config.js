module.exports = {
    "development": {
        "databases": {
            ...
            "loison": {
                "database": "picsou-loison", //you should always save these values in environment variables
                "username": "postgres",  //only for testing purposes you can also define the values here
                "password": "root",
                "host": "localhost",
                "dialect": "postgresql"  //here you need to define the dialect of your databse, in my case it is Postgres
            ...
            "maillard": {
                "database": "picsou-maillard", //you should always save these values in environment variables
                "username": "postgres",  //only for testing purposes you can also define the values here
                "password": "root",
                "host": "localhost",
                "dialect": "postgresql"  //here you need to define the dialect of your databse, in my case it is Postgres
